...
word_wrap1.set(True)
menu_bar.add_command(label="Formato", command= lambda : guarda_numero_variable_punto_inicio(text_area))
...
menu_bar.add_command(label="Ver", command= lambda : copy_quaterniones_txt(text_area))
...
menu_bar.add_command(label="Ayuda", command= lambda : copy_comandosMain_txt(text_area) )
